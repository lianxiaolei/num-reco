...
"load image data"
img = io.imread(
    r'C:\Users\Administrator.WIN-SJ36M83FJQ9\Music\378-ori.jpg')  # Gray image, rgb images need pre-conversion
...
ax1, ax2 = ax.ravel()
ax1.imshow(BW_Original)
ax1.set_title('Original binary image')
ax1.axis('off')
ax2.imshow(BW_Skeleton)
ax2.set_title('Skeleton by ZhangSuen Algo')
ax2.axis('off')
plt.show()
