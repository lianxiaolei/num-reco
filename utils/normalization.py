...
def chirography_normal(img, wid=2, eps=0, delta=5):
    ...
    for i in range(img.shape[0]):
        for j in range(img.shape[1]):
            ...
            total += distance[x - 1]
            print('args', count, total, total / count)
...
if __name__ == '__main__':
    ...
    img = cv2.imread(r'C:\Users\Administrator.WIN-SJ36M83FJQ9\Music\378-ori.jpg', cv2.IMREAD_GRAYSCALE)
    ...
    img[img > 1] = 1.
    #
    sub_img = chirography_normal(img, wid=3, delta=5)
